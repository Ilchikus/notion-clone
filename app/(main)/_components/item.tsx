...
import { ChevronDown, ChevronRight, LucideIcon, MoreHorizontal, Plus, Trash, TrashIcon } from "lucide-react";
...
export const Item = ({
    ...
    return (
        ...
        >
            ...
            {documentIcon ? (
                <div className="shrink-0 mt-2 text-[18px]">
                    {documentIcon}
                </div>
            ) : (
            ...
            {!!id && (
                <div className="ml-auto flex items-center gap-x-2">
                    ...
                    <div
                        role="button"
                        onClick={onCreate}
                        className="opacity-0 group-hover:opacity-100 h-ful ml-auto rounded-sm hover:bg-neutral-300
